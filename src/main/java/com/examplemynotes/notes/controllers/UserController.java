...
import com.examplemynotes.notes.models.RoleToUser;
...
public class UserController {
    ...
    public ResponseEntity<User> saveUser(@RequestBody User user) {
        URI location = URI
                .create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/user/save")
                        .toUriString());
    ...
    public ResponseEntity<Role> saveRole(@RequestBody Role role) {
        URI location = URI
                .create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/role/save")
                        .toUriString());
        return ResponseEntity.created(location).body(userService.saveRole(role));
    }

    @PostMapping("/role/addtouser")
    public ResponseEntity<User> addRoleToUser(@RequestBody RoleToUser form) {
    ...
    public void refreshToken(HttpServletRequest request,
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                tokens.put("accesss_token", access_token);
